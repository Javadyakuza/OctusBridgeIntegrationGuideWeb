...
import { GqlSocket, GqlSocketParams } from 'everscale-standalone-client/client/ConnectionController/gql';
import { JrpcSocket, JrpcSocketParams } from 'everscale-standalone-client/client/ConnectionController/jrpc';
export { GqlSocketParams } from 'everscale-standalone-client/client/ConnectionController/gql';
export { JrpcSocketParams } from 'everscale-standalone-client/client/ConnectionController/jrpc';
/**
 * @category Client
 */
