import { Address, Uint } from 'web3-types/lib/commonjs/eth_types.js';
import { SupportedProviders } from 'web3-types/lib/commonjs/web3_base_provider.js';
import { Bytes, HexString } from 'web3-types/lib/commonjs/primitives_types.js';
