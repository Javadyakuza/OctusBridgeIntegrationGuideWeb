import { Address } from 'web3-types/lib/commonjs/eth_types.js';
import { Bytes, Numbers } from 'web3-types/lib/commonjs/primitives_types.js';
import { FixedSizeArray } from 'web3-types/lib/commonjs/utility_types.js';
...
export declare type ContractAbi = ReadonlyArray<AbiFragment>;
...
export declare type ContractConstructorArgs<Abis extends ContractAbi> = {
    [Abi in FilterAbis<Abis, AbiConstructorFragment & {
        type: 'constructor';
