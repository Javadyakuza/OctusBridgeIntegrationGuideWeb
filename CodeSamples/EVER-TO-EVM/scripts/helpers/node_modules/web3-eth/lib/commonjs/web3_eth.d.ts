...
export declare class Web3Eth extends Web3Context<Web3EthExecutionAPI, RegisteredSubscription> {
     ...
     * ```
     */
    sendSignedTransaction<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(transaction: Bytes, returnFormat?: ReturnFormat, options?: SendTransactionOptions): import("web3-core").Web3PromiEvent<import("web3-types").TransactionReceipt, import("web3-eth/lib/commonjs/types.js").SendSignedTransactionEvents<ReturnFormat>>;
    /**
     ...
     * > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"
     */
    sign<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(message: Bytes, address: Address, returnFormat?: ReturnFormat): Promise<{
