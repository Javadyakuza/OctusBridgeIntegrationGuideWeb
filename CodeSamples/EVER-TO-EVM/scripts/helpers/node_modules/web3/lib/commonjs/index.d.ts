...
export * from 'web3/lib/commonjs/types.js';
export default Web3;
/**
...
export * as eth from 'web3/lib/commonjs/eth.exports.js';
export * as net from 'web3-net';
export * as providers from 'web3/lib/commonjs/providers.exports.js';
