import { AbiVersion, AbiParam, AssetType, AssetTypeParams, ContractState, ContractUpdatesSubscription, EncryptedData, EncryptionAlgorithm, FullContractState, Transaction, TransactionId, TransactionsBatchInfo, Permissions, Permission, FunctionCall, TokensObject, DelayedMessage } from 'everscale-inpage-provider/dist/models';
import { UniqueArray, Address } from 'everscale-inpage-provider/dist/utils';
/**
