import { Addressable, BalanceChangeInfoStorage, ErrorStore, MsgError, TraceType, ViewTrace, ViewTraceTree, ViewTraceTreeWithTotalFee } from "locklift/internal/tracing/types";
...
import { PrinterConfig } from "locklift/internal/tracing/viewTraceTree/utils";
import { Tokens } from "locklift/internal/tracing/viewTraceTree/tokens";
...
export declare class ViewTracingTree {
    ...
    findForContract: <C extends Contract<any>, N extends (keyof C["methods"] & string) | EventsNamesInner<C>, Abi extends C extends Contract<infer f> ? f : never, E extends N extends keyof C["methods"] & string ? MethodParams<C, N> : EventParams<Abi, N>>({ contract, name, }: {
        ...
        name: N;
    }) => (import("locklift/internal/tracing/types").DecodedMsg<N, MethodParams<C, N>> | undefined)[] | (import("locklift/internal/tracing/types").DecodedMsg<N, E> | undefined)[];
    findByType: <M extends string, P>(params: NameAndType) => (import("locklift/internal/tracing/types").DecodedMsg<M, P> | undefined)[];
