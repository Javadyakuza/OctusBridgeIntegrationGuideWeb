...
import { Addressable, AllowedCodes, OptionalContracts, TraceParams } from "locklift/internal/tracing/types";
import { Factory } from "locklift/internal/factory";
...
export declare class TracingInternal {
    ...
    trace({ inMsgId, allowedCodes, raise }: TraceParams): Promise<ViewTracingTree | undefined>;
