...
import { Trace } from "locklift/internal/tracing/trace/trace";
import { Optional } from "locklift/types";
...
export type RevertedBranch<Abi = unknown> = {
    totalActions: number;
    traceLog: Trace<Abi>;
    actionIdx: number;
};
...
export type DecoderOutput<Abi> = DecodedOutput<Abi, AbiFunctionName<Abi>> | DecodedInput<Abi, AbiFunctionName<Abi>> | DecodedEvent<Abi, AbiEventName<Abi>> | undefined;
export type DecodedMsg<M extends string = string, P extends Record<string, any> | any = Record<string, any>> = {
    method?: M;
    params?: P;
};
export type ViewTrace<M extends string = string, P extends Record<string, any> | any = Record<string, any>> = Pick<Trace, "msg" | "type" | "contract" | "error"> & {
    decodedMsg: DecodedMsg<M, P> | undefined;
};
export type ViewTraceTree<M extends string = string, P extends Record<string, any> = Record<string, any>> = ViewTrace<M, P> & {
