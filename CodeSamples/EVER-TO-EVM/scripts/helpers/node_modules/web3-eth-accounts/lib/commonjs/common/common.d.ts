...
import type { ConsensusAlgorithm, ConsensusType } from 'web3-eth-accounts/lib/commonjs/common/enums.js';
import { Chain, CustomChain, Hardfork } from 'web3-eth-accounts/lib/commonjs/common/enums.js';
import type { BootstrapNodeConfig, CasperConfig, ChainConfig, ChainsConfig, CliqueConfig, CommonOpts, CustomCommonOpts, EthashConfig, GenesisBlockConfig, GethConfigOpts, HardforkConfig } from 'web3-eth-accounts/lib/commonjs/common/types.js';
/**
